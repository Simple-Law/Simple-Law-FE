...
const Detail = ({ handleData, nextStep }) => {
  ...
  const { loading, fileList, setFileList, handleFileChange, uploadFileToServer } = useFileUpload();
  ...
  const handleSubmit = async () => {
    ...
    const fileUploadId = await uploadFileToServer(fileList[0]);
    setValue("fileUploadId", fileUploadId);
    trigger("fileUploadId");
    return fileUploadId;
  };
...
//   const messageApi = useMessageApi();
//   const dropAreaRef = useRef(null);
//   // const { loading, fileList, setFileList, handleFileChange } = useFileUpload();
